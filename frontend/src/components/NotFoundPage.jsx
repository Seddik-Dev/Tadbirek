...
export function NotFoundPage() {
  return (
    <div className="relative flex items-center justify-center px-4 sm:px-6 lg:px-8 py-16 bg-background">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div className="relative w-64 h-64 mx-auto mb-12">
          ...
          <div className="absolute inset-4 bg-white/90 rounded-2xl flex flex-col items-center justify-center p-6 shadow-lg">
            ...
            <div className="text-sm text-foreground/70">
              <div className="font-semibold text-primary mb-1">Page perdue</div>
        ...
        <div className="mt-12 pt-8 border-t border-border/50">
          <div className="inline-flex items-center gap-2 text-foreground/40 text-sm">
            ...
            <span>
              Saviez-vous ? 94% des utilisateurs de Tadbirek voient leur budget
              s'améliorer en 30 jours
            </span>
          </div>
        </div>
      </div>
